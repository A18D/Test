                    ...
                    <div class="row">
                        <div class="col-md-3 mt-md-0 mt-3 text-left">
                            ...
                            <div class="form-inline SpaceContainer">
                                <form class="form-group" action="https://www.vk.com" target="_blank">
                                    <button class=" btn btn-default VKBtn" type="submit" ><i class=" fa fa-vk"></i></button>
                                </form>
                                <span></span>
                                <form class="form-group" action="https://twitter.com" target="_blank">
                                    <button class=" btn btn-default TBtn" type="submit"><i class="fa fa-twitter"></i></button>
                                </form>
                                <span></span>
                                <form class="form-group" action="https://ru-ru.facebook.com/" target="_blank">
                                    <button class=" btn btn-default FBtn" ><i class="fa fa-facebook"></i></button>
                                </form>
                                <span></span>
                                <a href="https://www.instagram.com" target="_blank">
                                    <img src="/src/images/imgInstagram.jpg"
