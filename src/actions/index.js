import {LOAD_ALL_LESSONS, INCREMENT_CURRENT_TASK, INIT_CURRENT_TASK, INCREMENT_COUNT_RIGHT_ANSWERS, INIT_COUNT_RIGHT_ANSWERS, INCREMENT_COUNT_POINTS, 
    INIT_COUNT_POINTS, INCREMENT_COUNT_COINS, INIT_COUNT_COINS, ENABLE_TIP, DISABLE_TIP} from '../constants'

export function loadAllLesssons() {
    return {
        type: LOAD_ALL_LESSONS,
        callAPI: 'http://localhost:3001/api/lesson'
    }
}
